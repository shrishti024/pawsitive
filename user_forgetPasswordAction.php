...
<strong>You can set your password in the change password menu tab by filling in the System Genetrated Password as your old password.<strong>";
    $message = $str;
    ...
    header("location:user_forgetPassword.php?e=1");
