...
<div class="container mb-5">
    <h2>Checkout</h2>
    <form id="checkout-form" class="mb-5" action="product_checkoutAction.php">
        ...
        <div class="col-md-12">
            ...
            $select = "select * from pro_cart where user_email='" . $_SESSION['user'] . "'";
...
<script>
    ...
    const RazorPayResponse = (response) => {
        if (response.razorpay_payment_id !== "") {
            ...
            window.location.href="product_checkoutAction.php?fname="+fname+"&address="+address+"&city="+city+"&zip="+zip+"&state="+state+"&payment=online";
        } else {
