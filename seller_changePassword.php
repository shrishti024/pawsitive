        ...
        <section data-bg-img="images/pattern/p6.png">
            <div class="container">
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2" >
                            <form action="seller_changePassAction.php" method="post"
                                  class="seller_changePassword-form-transparent" id="seller-form">
                                <div class="row mb-4">
                                    <div class="col-md-8 col-md-offset-2" >
                                        <label for="email">Email:</label>
                                        <span class="form-control"><?php echo $email = $_SESSION['seller']; ?></span>
